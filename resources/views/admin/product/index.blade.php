                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'active'">{{ trans('admin.product.columns.active') }}</th>
                                        <th is='sortable' :column="'picture'">{{ trans('admin.product.columns.picture') }}</th>
                                        <th is='sortable' :column="'stock'">{{ trans('admin.product.columns.stock') }}</th>
